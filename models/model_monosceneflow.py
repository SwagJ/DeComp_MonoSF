...
from .modules_sceneflow import MonoSF_DispC_Decoder, ContextNetwork_DispC, ContextNetwork_Disp_DispC_v2_2, Disp_DispC_Decoder_v2_2, WarpingLayer_SF_DispC
...
class MonoSF_DispC(nn.Module):
    def __init__(self, args):
        ...
        self.corr_params = {"pad_size": self.search_range, "kernel_size": 1, "max_disp": self.search_range, "stride1": 1, "stride2": 1, "corr_multiply": 1}        
        self.context_networks = ContextNetwork_DispC(32 + 3 + 1)
        self.sigmoid = torch.nn.Sigmoid()
