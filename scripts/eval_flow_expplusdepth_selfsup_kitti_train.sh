...
CHECKPOINT="/disk_ssd/Self_Mono_Experiments/-flow-exp-plus-disp-/checkpoint_best.ckpt"

# model
MODEL=MonoSF_Disp_Exp_Plus
...
SAVE_PATH="/disk_ssd/self-mono-eval/-flow-exp-plus-disp-"
python ../main.py \
--batch_size=1 \
--batch_size_val=1 \
