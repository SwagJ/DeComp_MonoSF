...
CHECKPOINT="/disk_ssd/Self_Mono_Experiments/-monoexpansion-driving-rescale-/checkpoint_best.ckpt"
...
SAVE_PATH="/disk_ssd/self-mono-eval/-monoexpansion-driving-rescale-/"
python ../main.py \
--batch_size=1 \
--batch_size_val=1 \
