...
Train_Loss_Function=Loss_FlowDisp_SelfSup_CensusFlow_SSIM_Disp

Valid_Dataset=KITTI_Raw_KittiSplit_Valid_mnsf
Valid_Augmentation=Augmentation_Resize_Only
Valid_Loss_Function=Loss_FlowDisp_SelfSup_CensusFlow_SSIM_Disp

ALIAS="-mono-flow-disp-warp-og-decoder-census-top-ssim-"
