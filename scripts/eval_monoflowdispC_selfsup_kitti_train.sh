...
CHECKPOINT="/disk_ssd/Self_Mono_Experiments/-monoflowdispC-v2-1-loss-v3/checkpoint_epoch25.ckpt"
...
SAVE_PATH="/disk_ssd/self-mono-eval/-monoflowdispC-v2-1-loss-v3/epoch_25"
python ../main.py \
--batch_size=1 \
--batch_size_val=1 \
