...
Train_Loss_Function=Loss_MonoFlowDisp_DispC_Sceneflow_v2_Consistency

Valid_Dataset=KITTI_Raw_KittiSplit_Valid_mnsf
Valid_Augmentation=Augmentation_Resize_Only
Valid_Loss_Function=Loss_MonoFlowDisp_DispC_Sceneflow_v2_Consistency

ALIAS="-flowdisp-dispC-loss-consistency-"
