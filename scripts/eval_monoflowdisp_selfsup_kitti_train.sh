...
CHECKPOINT="/disk_ssd/Self_Mono_Experiments/-mono-flow-disp-warp-feat-norm-top-/checkpoint_best.ckpt"
...
SAVE_PATH="/disk_ssd/self-mono-eval/-mono-flow-disp-warp-feat-norm-top-"
python ../main.py \
--batch_size=1 \
--batch_size_val=1 \
