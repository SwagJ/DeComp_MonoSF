...
ALIAS="-mono-flow-disp-warp-feat-norm-top-lr-v2"
SAVE_PATH="$EXPERIMENTS_HOME/$ALIAS/"

CHECKPOINT="$EXPERIMENTS_HOME/-mono-flow-disp-warp-feat-norm-top-/checkpoint_epoch20.ckpt"
...
--lr_scheduler_milestones="[10, 20, 25, 30, 34, 37]" \
--model=$MODEL \
--num_workers=10 \
--optimizer=Adam \
--optimizer_lr=1e-4 \
