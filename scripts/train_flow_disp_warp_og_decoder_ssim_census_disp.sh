...
Train_Loss_Function=Loss_FlowDisp_SelfSup_CensusFlow_SSIM_Disp_v2

Valid_Dataset=KITTI_Raw_KittiSplit_Valid_mnsf
Valid_Augmentation=Augmentation_Resize_Only
Valid_Loss_Function=Loss_FlowDisp_SelfSup_CensusFlow_SSIM_Disp_v2

ALIAS="-mono-flow-disp-warp-og-decoder-census-ssim-disp-"
