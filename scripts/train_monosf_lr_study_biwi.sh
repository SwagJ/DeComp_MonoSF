...
# save path
CHECKPOINT="/scratch_net/phon/majing/src/exps/lr_study/MultiStepLR/Init0.4/8_23_39_47_54/checkpoint_latest.ckpt"
...
SAVE_PATH="$EXPERIMENTS_HOME/lr_study/$LR_Type/Init$Init_LR_with_gamma$LR_GAMMA/8_23_39_47_54"
