...
from .kitti_raw_monosf import KITTI_Raw,KITTI_Raw_Depth_KittiSplit_Train
from .kitti_raw_monosf import KITTI_Raw_Depth_KittiSplit_Full,KITTI_Raw_Depth_KittiSplit_Valid
...
class KITTI_Raw_for_SemiDepthSup(KITTI_Raw):
	...
	def __getitem__(self, index):
		...
		common_dict = {
			...
			"datename": datename,
			"input_size": input_im_size,
			"disp_l1": void_tensor1,
			"disp_l1_mask": void_tensor1,
			"disp_l2": void_tensor1,
			"disp_l2_mask": void_tensor1,
			"disp_r1": void_tensor1,
			"disp_r1_mask": void_tensor1,
			"disp_r2": void_tensor1,
			"disp_r2_mask": void_tensor1
		}
...
class KITTI_Comb_Train_Depth(ConcatDataset):  
	def __init__(self, 
				 args,
				 root,
				 flip_augmentations=True,
		...
		super(KITTI_Comb_Train_Depth, self).__init__(
			datasets=[self.dataset1, self.dataset2])
