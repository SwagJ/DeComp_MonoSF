...
def _parse_arguments():
    ...
    add("--save_flow_otl", type=tools.str2bool, default=False)
    add("--save_disp_otl", type=tools.str2bool, default=False)
    add("--save_disp2_otl", type=tools.str2bool, default=False)
